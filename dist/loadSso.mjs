...
import 'crypto';
import 'fs';
import { getSmithyContext, normalizeProvider, resolveAwsSdkSigV4Config, EndpointCache, resolveEndpoint, customEndpointFunctions, awsEndpointFunctions, fromBase64, toBase64, AwsSdkSigV4Signer, NoAuthSigner, NoOpLogger, parseUrl, fromUtf8, toUtf8, emitWarningIfUnsupportedVersion, emitWarningIfUnsupportedVersion$1, calculateBodyLength, createDefaultUserAgentProvider, loadConfig, NODE_MAX_ATTEMPT_CONFIG_OPTIONS, NODE_REGION_CONFIG_FILE_OPTIONS, NODE_REGION_CONFIG_OPTIONS, NodeHttpHandler, NODE_RETRY_MODE_CONFIG_OPTIONS, DEFAULT_RETRY_MODE, Hash, streamCollector, NODE_USE_DUALSTACK_ENDPOINT_CONFIG_OPTIONS, NODE_USE_FIPS_ENDPOINT_CONFIG_OPTIONS, NODE_APP_ID_CONFIG_OPTIONS, resolveDefaultsModeConfig, loadConfigsForDefaultMode, getDefaultExtensionConfiguration, getHttpHandlerExtensionConfiguration, resolveAwsRegionExtensionConfiguration, resolveDefaultRuntimeConfig, resolveHttpHandlerRuntimeConfig, getAwsRegionExtensionConfiguration, Client, resolveUserAgentConfig, resolveRetryConfig, resolveRegionConfig, resolveEndpointConfig, getUserAgentPlugin, getRetryPlugin, getContentLengthPlugin, getHostHeaderPlugin, getLoggerPlugin, getRecursionDetectionPlugin, getHttpAuthSchemeEndpointRuleSetPlugin, DefaultIdentityProviderConfig, getHttpSigningPlugin, resolveHostHeaderConfig, ServiceException, SENSITIVE_STRING, requestBuilder, map, isSerializableHeaderValue, expectNonNull, expectObject, parseJsonBody, take, parseJsonErrorBody, loadRestJsonErrorCode, withBaseException, decorateServiceException, _json, expectString, Command, getSerdePlugin, getEndpointPlugin } from './core.mjs';
import 'buffer';
import 'stream';
import 'http';
import 'https';
