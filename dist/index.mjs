import { TokenProviderError, getSSOTokenFilepath, parseKnownFiles, getProfileName, loadSsoSessionData, getSSOTokenFromFile, CredentialsProviderError, setCredentialFeature } from './core.mjs';
import 'os';
import 'path';
import 'crypto';
...
const getSsoOidcClient = async (ssoRegion, init = {}) => {
    const { SSOOIDCClient } = await import('./index7.mjs');
...
const getNewSsoOidcToken = async (ssoToken, ssoRegion, init = {}) => {
    const { CreateTokenCommand } = await import('./index7.mjs');
